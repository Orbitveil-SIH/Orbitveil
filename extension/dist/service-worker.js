...
function isPhishingTargetUrl(url) {
  ...
  return normalized.includes("mode=malicious") || normalized.includes("phishing") || normalized.includes("fake-bank") || normalized.includes("fake-site") || normalized.includes("securebank") || normalized.includes("bankofsecure") || normalized.includes("verify-your-account") || normalized.includes("account-recovery") || normalized.includes("malicious");
}
